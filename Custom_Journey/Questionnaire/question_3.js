...
const q1a = document.getElementById("q3-a");
q1a.onclick = function() {select("q3-a")};

const q1b = document.getElementById("q3-b");
q1b.onclick = function() {select("q3-b")};

const q1c = document.getElementById("q3-c");
q1c.onclick = function() {select("q3-c")};
