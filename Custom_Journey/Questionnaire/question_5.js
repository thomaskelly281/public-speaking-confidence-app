...
const q1a = document.getElementById("q5-a");
q1a.onclick = function() {select("q5-a")};

const q1b = document.getElementById("q5-b");
q1b.onclick = function() {select("q5-b")};

const q1c = document.getElementById("q5-c");
q1c.onclick = function() {select("q5-c")};

const q1d = document.getElementById("q5-d");
q1d.onclick = function() {select("q5-d")};

const q1e = document.getElementById("q5-e");
q1e.onclick = function() {select("q5-e")};

const q1f = document.getElementById("q5-f");
q1f.onclick = function() {select("q5-f")};

const q1g = document.getElementById("q5-g");
q1g.onclick = function() {select("q5-g")};
...
//     if (ans === "q3-a") {
//         window.location.replace("question_4.html");
//     } else {
