...
const q1a = document.getElementById("q4-a");
q1a.onclick = function() {select("q4-a")};

const q1b = document.getElementById("q4-b");
q1b.onclick = function() {select("q4-b")};

const q1c = document.getElementById("q4-c");
q1c.onclick = function() {select("q4-c")};
...
function submit() {
    ...
    if (ans === "q4-a") {
        window.location.replace("question_5.html");
    } else {
